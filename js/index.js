...
async function displayData() {
   try {
      ...
      let currentNameDay = weekDays[getWeekDay(forecastDay[0].date).getDay()];
      let currentDayMonth = months[getWeekDay(forecastDay[0].date).getMonth()];
      let currentMonthNum = new Date().getDate();
   ...
   <div class="col-lg-4">
   <div class="forecast-current card  h-100">
      <div class="card-header hstack justify-content-between">
         ...
         <h5
            class="current-date mb-0 small text-white text-opacity-50 fw-light"
         >
            ${currentMonthNum}${currentDayMonth}
         </h5>
      </div>
      <div class="card-body">
         <h4
         ...
         >
            ...
            <img src="${forecastContainer.current.condition.icon}" alt=" weather icon" />
         </div>
         <span
...
<div class="col-lg-4">
   <div
      class="forecast-current card mid  h-100 text-center"
   >
...
<div class="col-lg-4">
   <div
      class="forecast-current card  h-100 text-center"
   >
      <div class="card-header">
         <h4
            class=" mb-0 h6 text-white text-opacity-50"
